const date = () => {
    let date_main = new Date("December,28,2023,24:00:00");
    ...
    document.getElementsByClassName('time')[0].innerHTML = `<span>${date_day}<br><h6>Days</h6></span>
    <h5>:</h5>
    <span>${date_hour}<br><h6>Hours</h6></span>
    <h5>:</h5>
    <span>${date_min}<br><h6>Minutes</h6></span>
    <h5>:</h5>
    <span>${date_sec}<br><h6>Second</h6></span>`
}
